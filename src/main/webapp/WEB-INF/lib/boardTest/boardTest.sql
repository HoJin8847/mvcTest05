...
insert into test values('zxc', '4321', 49, '여', '제주');
insert into test values('xcv', '4321', 22, '남', '서울');
insert into test values('cvb', '4321', 32, '여', '청주');
insert into test values('vbn', '4321', 42, '남', '광주');
insert into test values('bnm', '4321', 52, '여', '인천');
...
delete form test where mid = 'dtom';
...
insert into boardTest values (default, '관리자', '게시판 서비르를 시작합니다.', '즐거운 게시판 생활하기', '192.168.50.20', default, default);
